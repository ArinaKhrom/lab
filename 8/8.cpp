...
void printStudent(student* st) {
	cout << st->surname << " " << st->name << " " << st->otchestvo << " Дата рождения: " << st->dateOfBirth << " Адрес: " << st->adress << " Рейтинг: " << st->rank << "\n";
}
...
void main() {
	...
	//УДАЛЕНИЕ СТУДЕНТОВ С ОДНОЙ ДАТОЙ РОЖДЕНИЯ
	...
	//Добавление студента перед студентом с данной фамилией
